...
const knownRoutes = Object.fromEntries(apps.map(app => {
  var _app$app;
  return [(_app$app = app.app) !== null && _app$app !== void 0 ? _app$app : app.id, app.href];
}));
/**
...
//# sourceMappingURL=apps_settings_src_components_AppStoreDiscover_PostType_vue-apps_settings_src_components_AppStoreDiscover_PostType_vue.js.map?v=0990a314433d8380587b